...
/** This main class creates an app that manages inventory.
 @author Ginna Campbell
 */
public class Main extends Application {

    /** This is the start method. This method loads the inventory.fxml file. */
    @Override
    ...
    public static void main(String[] args) {
        ...
        Outsourced outsourcedPart = new Outsourced(2, "Break", 250.00, 10, 5, 20, "parts.com");
